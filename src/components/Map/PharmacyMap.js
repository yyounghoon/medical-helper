...
const PharmacyMap = () => {
  ...
  const data = useSelector(({ pharmacy }) => pharmacy.pharmacyList);
  ...
  const mapContainer = (lat, lon, data) => {
    ...
    data.forEach((data) => {
      ...
      var content = `<div class ="label"><span class="left"></span><span class="center">${data.dutyName}</span><span class="right"></span></div>`;
